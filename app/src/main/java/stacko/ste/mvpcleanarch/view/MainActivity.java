package stacko.ste.mvpcleanarch.view;
...
import stacko.ste.mvpcleanarch.espressotest.util.checknetwork.ConnectionLiveData;
import stacko.ste.mvpcleanarch.view.adapters.RepoListAdapter;
...
public class MainActivity extends AppCompatActivity implements MainActivityView, RepoListAdapter.OnItemClickListener {
    ...
    @Override
    public void writeToStatusBackOnline() {
        statusMessage(getString(R.string.online));
    }

    @Override
    public void writeToStatusOffline() {
